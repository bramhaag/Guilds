...
public class CommandDemote extends CommandBase {
    ...
    public CommandDemote(String name, String description, String permission, boolean allowConsole, String[] aliases, String[] arguments, int minimumArguments, int maximumArguments) {
