...
public class CommandBoot extends CommandBase {
    ...
    public CommandBoot(String name, String description, String permission, boolean allowConsole, String[] aliases, String[] arguments, int minimumArguments, int maximumArguments) {
