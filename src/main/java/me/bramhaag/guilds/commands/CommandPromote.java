...
public class CommandPromote extends CommandBase {
    ...
    public CommandPromote(String name, String description, String permission, boolean allowConsole, String[] aliases, String[] arguments, int minimumArguments, int maximumArguments) {
