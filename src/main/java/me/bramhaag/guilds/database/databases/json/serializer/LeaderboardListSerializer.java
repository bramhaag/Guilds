package me.bramhaag.guilds.database.databases.json.serializer;
...
public class LeaderboardListSerializer implements JsonSerializer<List<Leaderboard>> {
    ...
    @Override
    public JsonElement serialize(List<Leaderboard> src, Type type, JsonSerializationContext context) {
        Gson gson = new Gson();
